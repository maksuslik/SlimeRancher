package maksinus.sir_plavlenniy.guis;
...
public class SignGUI {
    ...
    public void SignGUI(Plugin plugin) {
    ...
    public void open(Player player, String[] defaultText, SignGUIListener response) {
        ...
        if (defaultText != null) {
            ...
            WrappedBlockData iblock = WrappedBlockData.createData(Material.OAK_SIGN);
    ...
    public void openSign(Player p) {
        open(p, new String[]{"test0", "test1", "test2", "test3"}, (player, lines) -> System.out.println(lines[0]));
    }
}
